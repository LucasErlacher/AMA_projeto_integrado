...
import br.com.amawebinterface.cgt.AplEndereco;
...
public class CadastroEnderecoTest {
    ...
    public void umEnderecoCadastrado() throws Throwable {
        //defnido pegar o endercod e id 2  
        this.endereco = this.aplendereco.consultaEndereco(new Long(2));
        //this.endereco.setComplemento("Muito Longe");
    ...
    public void entroComDadosNovos() throws Throwable {
        ...
        aplendereco.alterarDadosEndereco(this.endereco, "198", "502");  
        this.endereco = aplendereco.consultaEndereco(new Long(2));
    ...
    public void receboUmaMensagemInformandoQueOsDadosForamAlterados() throws Throwable {
        ...
        if ("198".equals(this.endereco.getNumero()) && "502".equals(this.endereco.getComplemento())) {
            result = true;
        }
